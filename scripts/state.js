...
export const SHOP_ITEMS = [
  {
    ...
    name: 'Bombo',
    price: 0,
    icon: 'public/images/icon_kick.png',
    sample: 'public/audio/kick.wav',
  },
  {
    id: 'tom',
    kind: 'drum',
    name: 'Tom',
    price: 5,
    icon: 'public/images/icon_tom.png',
    sample: 'public/audio/tom.wav',
  },
  {
    id: 'cymbal',
    kind: 'drum',
    name: 'Plato',
    price: 20,
    icon: 'public/images/icon_cymbal.png',
    sample: 'public/audio/cymbal.wav',
  },
  {
    id: 'snare',
    kind: 'drum',
    name: 'Caja',
    price: 50,
    icon: 'public/images/icon_snare.png',
    sample: 'public/audio/snare.wav',
  },
  // Upgrades
  ...
  { id: 'vampire', kind: 'costume', name: 'Disfraz de Vampiro', price: 100, face: 'y', body: 'y' },
  {
    id: 'gnome',
    kind: 'costume',
    name: 'Disfraz de Mago',
    price: 300,
    face: 'y',
    body: 'y',
    armRight: 'y',
    armLeft: 'y',
    sample: 'public/audio/gnome.mp3',
  },
  {
    id: 'firecape',
    kind: 'costume',
    ...
    body: 'gif',
    armLeft: 'y',
    sample: 'public/audio/runescape.mp3',
  },
  // Drum skins
  {
    id: 'cursed',
    ...
    name: 'Bombo Maldito',
    price: 666,
    sample: 'public/audio/jumpscare.mp3',
    equip: 'public/audio/kick.wav',
    target: 'kick',
    image: 'public/images/drum_cursed.png',
    tap: 'public/images/drum_tap_cursed.png',
  },
  {
    id: 'oiia',
    kind: 'skin',
    name: 'Bombo OIIA',
    price: 5000,
    sample: 'public/audio/oiia.mp3',
    target: 'kick',
    image: 'public/images/drum_oiia.png',
    tap: 'public/images/drum_tap_oiia.gif',
  },
  {
    id: 'skull',
    kind: 'skin',
    name: 'Tom de Calaveras',
    price: 130,
    sample: 'public/audio/skull.mp3',
    target: 'tom',
    image: 'public/images/tom_skull.png',
    tap: 'public/images/tom_tap_skull.png',
  },
  {
    id: 'goomba',
    kind: 'skin',
    name: 'Tom Goomba',
    price: 700,
    sample: 'public/audio/goomba.mp3',
    target: 'tom',
    image: 'public/images/tom_goomba.png',
    tap: 'public/images/tom_tap_goomba.png',
  },
  {
    id: 'blood',
    kind: 'skin',
    name: 'Plato de Sangre',
    price: 210,
    sample: 'public/audio/blood.mp3',
    target: 'cymbal',
    image: 'public/images/cymbal_blood.png',
    tap: 'public/images/cymbal_tap_blood.png',
  },
  {
    id: 'bombardino',
    kind: 'skin',
    name: 'Plato Bombardino',
    price: 3000,
    sample: 'public/audio/bombardino.mp3',
    target: 'cymbal',
    image: 'public/images/cymbal_bombardino.png',
    tap: 'public/images/cymbal_tap_bombardino.png',
  },
  {
    id: 'ghost',
    kind: 'skin',
    name: 'Caja Fantasma',
    price: 330,
    sample: 'public/audio/ghost.mp3',
    target: 'snare',
    image: 'public/images/snare_ghost.png',
    tap: 'public/images/snare_tap_ghost.png',
  },
  {
    id: 'kolog',
    kind: 'skin',
    name: 'Caja Kolog',
    price: 2500,
    sample: 'public/audio/kolog.mp3',
    target: 'snare',
    image: 'public/images/snare_kolog.png',
    tap: 'public/images/snare_tap_kolog.png',
  },
  // Backgrounds (can be purchased and equipped via the shop)
  {
    id: 'graveyard',
    kind: 'background',
    name: 'Fondo: Cementerio',
    price: 0,
    image: 'public/background/graveyard.jpg',
  },
  {
    id: 'forest',
    kind: 'background',
    name: 'Fondo: Bosque',
    price: 30,
    image: 'public/background/forest.jpg',
  },
  {
    id: 'stage',
    kind: 'background',
    ...
    price: 70,
    image: 'public/background/stage.jpg',
  },
];
